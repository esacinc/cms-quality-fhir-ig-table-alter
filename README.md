...
~~~ 
### Legend:     
- **generatedHTMLFile** Indicates the full pathname of the html file to edit. (The name 'generated-...' implies editing an html file that was generated by the IG tooling)  
- **outputHTMLFfile** This is an optional element. If provided, then the edited html document will be written to a file with this full pathname.  If not provided, the edited html document will overwrite the original file (indicated by the generatedHTMLFile pathname).  
