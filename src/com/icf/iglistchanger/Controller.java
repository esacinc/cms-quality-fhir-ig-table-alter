 ...
 * <b>behavior</b>  if present, specifies how to alter the table to include sorting, pagination and/or search capabilities (using the <b>DataTables</b> jquery plugin.)
 *         <b>sorting</b>        -  if present, and if value is <i>true</i>, then add ability to sort columns by clicking on the column header
 *         <b>searching</b>      -  if present, and if value is <i>true</i>, then add a search bar above the table to enable searching table contents
 *         <b>paging</b>         -  if present, and if value is <i>true</i>, then add pagination to the table
 *         <b>pageSize</b>       -  if present, and if paging is <i>true</i>, then sets the size of the pages (number of rows) to display per page. Default is 10
 *         <b>pageSizeChange</b> -  if paging is <i>true</i>, and if present and value is <i>true</i>, then provides a drop-down list allowing user to change page size.  
...
public class Controller {
	...
	public void processTableHeader() {
		...
		SearchSort sort = new SearchSort(this.currDescriptor.getElementsByTag("behavior").get(0), this.targetTablePos);
    ...
    */
	private void setCurrDescriptor(Element el) {
    ...
    */
	private String getControlValue(String tagname) {
		try {
    ...
    */
	private Elements getNewColumnSpecs(String pos) {
   ...
   */
	private String getResourceFieldValue(JSONObject resource, Element colSpec) {
