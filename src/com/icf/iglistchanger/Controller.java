 ...
 * <b>addOns</b>  if present, specifies how to alter the table to include sorting, pagination and/or search capabilities (using the <b>DataTables</b> jquery plugin.)
 *         <b>ordering</b>         -  if present, and if value is <i>true</i>, then add ability to sort columns by clicking on the column header
