...
public class Controller {
	...
	public void setCurrDescriptor(Element el) {
		/*
			 <table-descriptor>
		        ...
		        <key-column-field>title</key-column-field>
		        <key-column-pos>0</key-column-pos>
		        <oldColumn old-pos="0" action="keep" resource-field="title"></oldColumn>
		        <newColumn after-pos="0" label="CMS ID" resource-field="identifier"></newColumn>
		...
		System.out.println("\n\nProcessing " + getControlValue("generated-html-file"));

		htmlDoc = FileUtils.parseXHtmlFile(getControlValue("generated-html-file")); // open the actual html file (generated by tooling) as an html Document
		...
		resourceDir = getControlValue("resource-directory");                     // where the resource files are located
		resourceFilenames = FileUtils.getDirFiles(resourceDir);                  // the list of resource filenames found in the above dir
		outputHTMLFilename = getControlValue("output-HTML-file");                // Optional name of a file to output when we finish editing. (If not present, we overwrite the original.)
		if (null == outputHTMLFilename) {
			outputHTMLFilename = getControlValue("generated-html-file");
		}
	...
	public Elements getOldColumnSpecs() {
		return (currDescriptor == null)? null: currDescriptor.getElementsByAttribute("old-pos");
	...
	public Elements getNewColumnSpecs() {
		return (currDescriptor == null)? null: currDescriptor.getElementsByAttribute("after-pos");
	...
	public Elements getNewColumnSpecs(String pos) {
		return (currDescriptor == null)? null: currDescriptor.getElementsByAttributeValue("after-pos", pos);
	...
	public String getResourceFieldValue(JSONObject resource, Element colSpec) {
		...
		String field = colSpec.attr("resource-field");   // The name of the field in the json resource to get
